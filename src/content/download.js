...
export default {
  ...
  supportedOS: [
    {
      ...
      downloadLinks: {
          32: 'https://imgur.com/download/ckhMDWL',
          64: 'https://imgur.com/download/SinMCvT',
      }
    },
    {
      id: 'win',
  ...
  setupSteps: [
    {
      title: 'Unzip to install',
      body: [
        { component: Paragraph, content: "On Linux or OSX you can unzip holepunch from a terminal with the following command. On Windows, just double click holepunch.zip." },
        { component: Code, content: "$  unzip /path/to/holepunch.zip" },
      ],
    },
    {
      title: 'Connect your account',
      body: [
        { component: Paragraph, content: "Running this command will add your authtoken to your holepunch.yml file. Connecting an account will list your open tunnels in the dashboard, give you longer tunnel timeouts, and more. Visit the dashboard to get your auth token." },
        { component: Code, content: "$  ./holepunch authtoken <YOUR_AUTH_TOKEN>" },
        { component: (props) => <Link to="/signup" {...props}/>, content: "Sign up for free to get your auth token." },
      ]
    },
    {
      title: 'Fire it up',
      body: [
        { component: Paragraph, content: "Try it out by running it from the command line:" },
        { component: Code, content: "$  ./holepunch help" },
        { component: Paragraph, content: "To start a HTTP tunnel on port 80, run this next:" },
        { component: Code, content: "$  ./holepunch http 80" },
      ]
    },
  ]
}
